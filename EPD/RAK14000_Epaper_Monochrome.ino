...
/*
  EXPERIMENT ADJUSTMENTS BY DS, NOT PART OF ORIGINAL CODE:
...
/******************************************************/
/********************** DS NOTE ***********************/
/* My device is labeled with ...41HP, but the         */
/* hardcoded intigers are incorrect for 41HP.         */
/* I've selected the ...42HP config because those     */
/* intigers line up with my device a bit better.      */
/* 212 is the max pixels in the x dimension.          */
/* 104 is the max pixels in the y dimension.          */
/* The rest of them I believe are set to place items  */
/* on the screen in pre-set / templated locations.    */
/******************************************************/
/******************************************************/
